...
def SpawnNewAnimal(animal_type, animal_location, animal_sight_range,animaml_draw_colour) -> animal:
    return animal(animal_ID = 0, animal_type = animal_type, animal_location=animal_location,animal_next_move = (), animal_alive = True, animal_sight_range = animal_sight_range,animaml_draw_colour = animaml_draw_colour)
